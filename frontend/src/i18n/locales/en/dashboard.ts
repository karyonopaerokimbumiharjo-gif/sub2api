export default {
  ...
  usage: {
    ...
    latencyFirstTokenWithoutAudit: 'First (no audit)',
    latencyFirstTokenWithAudit: 'First (with audit)',
    latencyDurationWithoutAudit: 'Total (no audit)',
    latencyDurationWithAudit: 'Total (with audit)',
    audit: 'Audit result', auditEvidenceHint: 'Only retained audit evidence is shown. Missing historical records do not prove a request was unaudited; native results expire with audit retention.', auditSource: { native: 'Native audit', custom: 'Custom audit' }, auditResult: { partial: 'Partial audit; incomplete coverage', passed: 'Passed', blocked: 'Blocked', flagged: 'Flagged', error: 'Audit error', inconclusive: 'Inconclusive', notAudited: 'Not audited', timed: 'Timed; verdict not retained', unknown: 'No retained record; unknown' },
    promptAuditLatency: 'Prompt audit latency',
    tps: 'Average TPS',
    tpsHint: 'Average output tokens per second = output tokens / recorded total duration, including time to first token, for all request types. This is a request-level average, not model decoding speed. Missing/invalid token or duration measurements and image requests show —.',
