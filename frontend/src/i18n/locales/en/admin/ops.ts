export default {
    ops: {
      ...
      errorLog: {
        ...
        upstreamTransportStatus: 'Upstream Transport Status',
        message: 'Message',
        ip: 'IP',
        ...
        endpoint: 'Endpoint',
        aggregatedCount: 'Merged {count} events',
        aggregatedRange: 'Raw events are retained; range: {first} to {last}',
        requestType: 'Type',
      ...
      errorDetails: {
        ...
        collapseRouting: 'Merge repeated routing errors',
        collapseRoutingHint: 'Only merges identical no-account routing errors within five minutes; raw events are retained',
