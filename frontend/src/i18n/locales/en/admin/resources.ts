export default {
    ...
    proxies: {
      ...
      clashImportTitle: 'Import Clash Nodes',
      clashImportHint: 'Upload a Clash config or paste its contents/proxy URLs. Nodes are previewed and deduplicated before import.',
      clashImportSupported: 'Directly supported: HTTP, HTTPS, SOCKS5/SOCKS5H. SS, VMess, VLESS, Trojan and other transports are shown as unsupported and are not silently imported.',
      clashImportFile: 'Clash config file',
      clashImportSelectFile: 'Choose a YAML, JSON, or text file',
      clashImportPastePlaceholder: 'Paste Clash YAML/JSON, or one http:// or socks5:// proxy URL per line',
      clashImportValid: '{count} importable',
      clashImportUnsupported: '{count} unsupported',
      clashImportInvalid: '{count} invalid',
      clashImporting: 'Importing...',
      clashImportButton: 'Import nodes',
      clashImportNoValid: 'No importable nodes found',
      clashImportSuccess: 'Clash import complete: {created} added, {skipped} skipped',
      clashImportFailed: 'Failed to import Clash nodes',
      clashImportCopyTemplate: 'Copy template',
      clashImportDownloadTemplate: 'Download template',
      clashImportTemplateCopied: 'Template copied',
      clashImportTemplateCopyFailed: 'Unable to copy template',
      ...
      sub2AccountsCount: 'Sub2 account settings: {count}',
      testExitLabel: 'Proxy test exit',
      egressEvidenceHint: 'IP and location come from this proxy’s connection test. Binding counts describe saved configuration, not the actual egress of a Pi or CPA request.',
      savedBindingHint: 'Includes disabled or unused CPA credential bindings; this does not establish Pi egress.',
      cpaCredentialsCount: 'Saved CPA bindings: {count}',
      cpaBindingsUnknown: 'CPA binding status unavailable',
      accountsTitle: 'Accounts configured with this proxy',
      accountsEmpty: 'No Sub2 accounts are configured with this proxy',
