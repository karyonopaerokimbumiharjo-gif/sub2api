export default {
    accounts: {
      ...
      switchToPi: 'Switch to Pi (reuse authorization)',
      switchToCpa: 'Switch to CPA (reuse authorization)',
      switchToPiSuccess: 'Switched to Pi without re-authorizing',
      switchToCpaSuccess: 'Switched to CPA without re-authorizing',
      switchBackendFailed: 'Backend switch failed; the current account was kept unchanged',
      ...
      expired: 'Expired',
      proxy: 'Proxy',
      proxyUnavailable: 'Bound proxy #{id} (unavailable or not loaded)',
      noProxy: 'No Proxy',
