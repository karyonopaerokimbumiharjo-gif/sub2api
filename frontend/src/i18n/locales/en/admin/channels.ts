export default {
    ...
    riskControl: {
      ...
      recordNonHitsDisabled: 'Passed requests are not retained. To see native verdicts in usage records, enable Record non-hits under Content audit settings → Runtime and save.',
