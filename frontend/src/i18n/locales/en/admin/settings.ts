    ...
    settings: {
      ...
      apiKeyAcl: {
        ...
        trustForwardedIpHint:
          'When enabled, custom and legacy IP headers are accepted only from server.trusted_proxies. When disabled, use the Gin trusted-proxy chain. Direct clients cannot override their source IP. Changing this setting may affect existing session IP fingerprints.',
        ...
        forwardedClientIpHeadersRiskHint: 'Trusted proxies must replace client-supplied IP headers with the actual source IP.',
