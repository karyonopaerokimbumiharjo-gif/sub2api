export default {
    ops: {
      ...
      errorLog: {
        ...
        status: '状态码',
        finalStatus: '最终状态码',
        upstreamTransportStatus: '上游传输状态',
        message: '响应内容',
        ip: 'IP',
        latency: '请求时长',
        action: '操作',
        ...
        typeInternal: '内部',
        endpoint: '端点',
        aggregatedCount: '合并 {count} 次',
        aggregatedRange: '原始记录保留；时间范围：{first} 至 {last}',
        requestType: '类型',
        requestTypeSync: '同步',
      ...
      errorDetails: {
        ...
        viewErrors: '错误',
        viewExcluded: '排除项',
        collapseRouting: '合并重复路由错误',
        collapseRoutingHint: '仅合并五分钟内相同的无可用账号提示；原始记录不会删除',
        statusCodeOther: '其他',
        owner: {
          provider: '服务商',
          client: '客户端',
