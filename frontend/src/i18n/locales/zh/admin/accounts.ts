export default {
    accounts: {
      ...
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      switchToPi: '切换到 Pi（复用授权）',
      switchToCpa: '切换到 CPA（复用授权）',
      switchToPiSuccess: '已复用原授权切换到 Pi',
      switchToCpaSuccess: '已复用原授权切换到 CPA',
      switchBackendFailed: '切换失败，当前账号保持不变',
      noAccountsYet: '暂无账号',
      ...
      openaiQuotaReset: {
        ...
        resetTooltipReady: '消耗 1 次重置次数以恢复七天额度',
        ...
        resetSuccess: '七天额度重置完成，次数和账号状态已更新',
        ...
        confirmTitle: '确认重置周限',
        confirmMessage: '将消耗 1 次重置次数恢复七天额度，剩余 {count} 次。此操作不可撤销，确定继续吗？'
      },
      tier: {
        free: 'Free',
        pro: 'Pro',
      ...
      expired: '已过期',
      proxy: '代理',
      proxyUnavailable: '已绑定代理 #{id}（不可用或未加载）',
      noProxy: '无代理',
      concurrency: '并发数',
      loadFactor: '负载因子',
