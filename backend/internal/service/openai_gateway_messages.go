...
func (s *OpenAIGatewayService) ForwardAsAnthropic(
	...
	if account.UsesNativePiRuntime() {
		result, forwardErr := s.forwardNativePiCompat(ctx, c, account, responsesBody, promptCacheKey, originalModel, billingModel, upstreamModel, clientStream, true, startTime)
