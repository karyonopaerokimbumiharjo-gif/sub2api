...
// The probe writes asynchronously while the test observes its sanitized log.
...
func (b *grokProbeLogBuffer) Bytes() []byte {
	b.mu.Lock()
	defer b.mu.Unlock()
	return bytes.Clone(b.buffer.Bytes())
}
func (b *grokProbeLogBuffer) String() string { return string(b.Bytes()) }
