...
func init() {
	...
	// usagelogDescPromptAuditLatencyMs is the schema descriptor for prompt_audit_latency_ms field.
	usagelogDescPromptAuditLatencyMs := usagelogFields[35].Descriptor()
	// usagelog.PromptAuditLatencyMsValidator is a validator for the "prompt_audit_latency_ms" field. It is called by the builders before save.
	usagelog.PromptAuditLatencyMsValidator = usagelogDescPromptAuditLatencyMs.Validators[0].(func(int) error)
	...
	// userDescPromptAuditBypass is the schema descriptor for prompt_audit_bypass field.
	userDescPromptAuditBypass := userFields[22].Descriptor()
	// user.DefaultPromptAuditBypass holds the default value on creation for the prompt_audit_bypass field.
	user.DefaultPromptAuditBypass = userDescPromptAuditBypass.Default.(bool)
